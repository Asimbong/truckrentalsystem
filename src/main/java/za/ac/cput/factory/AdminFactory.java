...
public class AdminFactory {
    public static Admin buildAdmin(int adminID, String adminName, String adminSurname, String email) {
    ...
    public static Admin buildAdmin(String firstName, String lastName) {
        ...
        return new Admin.Builder().setAdminID(Integer.parseInt(adminId)).setAdminName(firstName)
